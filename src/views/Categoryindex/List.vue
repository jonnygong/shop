<template>
  <section>
    ...
    <el-table :data="list"
      ...
      <!-- <el-table-column prop="category_id" label="分类名称" min-width="120">
...
//        category_id: this.$route.params.category_id,
        ...
        const res = await this.$http.post(`categoryindexList`, params)
      ...
      async getArrayData () {
        ...
        if (res === null) return
        let category = {}
        // this.category_id = this.formateOptions(res.param)
      ...
      handleDel (index, row) {
        this.$confirm('确认删除该记录吗?', '提示', {
          ...
          const res = await this.$http.post(`categoryindexStatus`, params)
          if (res === null) return
          this.$message({
            message: '状态修改成功',
            type: 'success'

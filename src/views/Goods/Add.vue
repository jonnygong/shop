<template>
  <div class="form-wrapper">
    <el-form :model="formData" label-width="120px" :rules="formRules" ref="formData">
      <el-form-item label="分类名称" prop="category_id" style="margin-top: 20px">
        <el-select v-model="formData.category_id" placeholder="请选择分类名称" @change="getIndexData">
          <el-option
            v-for="(item,index) in options.category_id"
            :key="index"
            :label="item.name"
            :value="item.id">
          </el-option>
...
//        shop_id: 2,
        ...
        weight: 20,
        sort: 1,
        title: '安德鲁尤克里里23寸乌克丽丽26小吉他女男ukulele成人学生初学者',
        thumb: 'https://img.alicdn.com/imgextra/i2/2527507794/TB2UhuYfdzJ8KJjSspkXXbF7VXa_!!2527507794.jpg_60x60q90.jpg',
        description: 'fsfasd',
        // goods_sn: 2142423,
        // product_sn	: 'fsddfas',
        original_price: 323,
        ...
        // view_count: 123,
        // is_check: 12,
        content: '安德鲁尤克里里23寸乌克丽丽26小吉他女男ukulele成人学生初学者',
        index_id: '',
        category_path: '',
        address: '浙江杭州'
      }
  ...
  methods: {
    ...
    async getArrayData () {
      const res = await this.$http.post(`categoryArray`, {shop_id: sessionStorage.getItem("shop_id")})
      if (res === null) return
...
//            params.thumb_url = this.getImageList('album') // 多图上传
            params.thumb_url = 'https://gd3.alicdn.com/imgextra/i4/422873395/TB2UoMygoRIWKJjSZFgXXboxXXa_!!422873395.jpg_400x400.jpg', 'https://gd3.alicdn.com/imgextra/i4/422873395/TB2UoMygoRIWKJjSZFgXXboxXXa_!!422873395.jpg_400x400.jpg' // 多图上传
